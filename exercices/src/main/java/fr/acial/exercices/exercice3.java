...
public class exercice3{
  ...
  @Test (priority=1, dataProvider="Employees")
  public void addEmployee(String lastName, String firstname, String id) throws Exception {
	    ...
	    try {
	      assertEquals(driver.findElement(By.xpath("//div[@id='profile-pic']/h1")).getText(), "TESLA Bruno");
	    } catch (Error e) {
	      verificationErrors.append(e.toString());
	    }
  ...
  public void employeeDetails() throws Exception {
	    ...
	    driver.findElement(By.id("empsearch_id")).sendKeys("9002");

	    driver.findElement(By.id("searchBtn")).click();

	    try {
	        assertTrue(isElementPresent(By.linkText("9002")));
	      } catch (Error e) {
	        verificationErrors.append(e.toString());
	      }

	    driver.findElement(By.linkText("9002")).click();
  ...
  public void deleteEmployee() throws Exception {
	    ...
	    try {
	        assertEquals(driver.findElement(By.xpath("//table[@id='resultTable']/tbody/tr/td[3]")).getText(), "9002");
	      } catch (Error e) {
	        verificationErrors.append(e.toString());
	      }
